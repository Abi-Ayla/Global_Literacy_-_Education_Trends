...
engine = create_engine(
    "mysql+pymysql://iatXFmXH7cy5Eyv.root:ndGScqvE2B1dpP9p@gateway01.ap-southeast-1.prod.aws.tidbcloud.com:4000/literacy_gdp_analysis",
...
if page == "SQL Query Dashboard":
    ...
    # Education Trend
        ...
        title=f"{country} Average Years of Education vs literacy rate"
    )
